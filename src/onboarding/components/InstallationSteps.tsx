...
const InstallationSteps = () => {
    ...
    return (
        <Box>
            ...
            <Typography variant='h5' mt={4}>1. Install Git</Typography>
            <Typography>
            ...
            <Typography variant='h5' mt={3}>2. Open a Terminal</Typography>
            <Typography>
                On Windows: Press <strong>Win + X</strong> and select "Terminal"<br />
                On Mac: Open the "Terminal" app from Applications {`>`} Utilities
            </Typography>
            <Typography mt={2}>Navigate to your desired folder:</Typography>
            <Typography variant='h6'>On Windows:</Typography>
            <TerminalBox>
                cd C:\your-folder-path\
            </TerminalBox>
            <Typography variant='h6'>On Mac:</Typography>
            <TerminalBox>
                cd ~/your-folder-path/
            </TerminalBox>

            <Typography variant='h5' mt={3}>3. Clone the Repository</Typography>
            <TerminalBox>
                git clone https://github.com/50shadesofgwei/SynthetixFundingRateArbitrage.git
            </TerminalBox>

            <Typography variant='h5' mt={3}>4. Navigate to the Project Directory</Typography>
            <TerminalBox>cd SynthetixFundingRateArbitrage</TerminalBox>

            <Typography variant='h5' mt={3}>5. Install Python</Typography>
            <Typography>
            ...
            <Typography variant='h5' mt={3}>6. Create a Virtual Environment</Typography>
            <TerminalBox>python -m venv venv</TerminalBox>

            <Typography variant='h5' mt={3}>7. Activate the Virtual Environment</Typography>
            ...
            <Typography variant='h5' mt={3}>8. Install Dependencies</Typography>
            <TerminalBox>pip install -e .</TerminalBox>

            <Typography variant='h5' mt={3}>9. Run the Project UI</Typography>
            <TerminalBox>project-run-ui</TerminalBox>

            <Typography variant='h5' mt={3}>10. Find the </Typography>
            <Typography>
